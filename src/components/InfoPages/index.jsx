    ...
    return (
        <main className="info__page" ref={section}>
            <div className="info__content">
                ...
                <ContentBlock sections={sections} sectionRefs={sectionRefs} isHomeCountry={isHomeCountry} pathname={pathname}/>
            </div>
...
const ContentBlock = ({ sections, sectionRefs, isHomeCountry, pathname }) => {
    return (
