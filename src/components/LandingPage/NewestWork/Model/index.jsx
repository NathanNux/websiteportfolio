...
// const is causing error because the images are not loaded yet and the useTexture is used in callback function.
...
export default function Model ({ activeProject, containerRef }) {
    ...
    const textures = useProjectTextures(NewestProjects);
