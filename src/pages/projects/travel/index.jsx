...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="Project page summary and showcase about simple travel business website" />
      ...
      <CurveTransition>
        <TopBar name='My Soul' service='Improving' year='2024' style='Simplistic' price='$2000' link='https://travel-site-ivory-six.vercel.app/'/>
        <ZoomParallax 
