...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="Project page summary and showcase about framer-motion animation based website" />
      ...
      <CurveTransition>
        <TopBar name='My Soul' service='Improving' year='2024' style='Simplistic' price='$2000' link='https://framer-motion-simple-anim-basics.vercel.app/'/>
        <ZoomParallax 
