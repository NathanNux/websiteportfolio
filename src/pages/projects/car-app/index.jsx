...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="Project page summary and showcase about car-rental service app website" />
      ...
      <CurveTransition>
        <TopBar name='My Soul' service='Improving' year='2024' style='Simplistic' price='$2000' link='https://car-e-commmerce-serverside.vercel.app/'/>
        <ZoomParallax 
        ...
        <Intro src='/assets/images/ps/carapp.webp'/>
        <Sections 
          photos={photos}
