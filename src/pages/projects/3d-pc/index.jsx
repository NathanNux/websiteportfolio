...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="Project page summary and showcase about 3d-pc website" />
      ...
      <CurveTransition>
        <TopBar name='My Soul' service='Improving' year='2024' style='Simplistic' price='$3000' link='https://3-d-website-pc-globe.vercel.app/'/>
        <ZoomParallax 
