...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="Project page summary and showcase about blog template website" />
      ...
      <CurveTransition>
        <TopBar name='My Soul' service='Improving' year='2024' style='Simplistic' price='$2000' link='https://blog-website-tan-phi.vercel.app/'/>
        <ZoomParallax 
          ...
          path='/assets/a-footage/blog.webm'
